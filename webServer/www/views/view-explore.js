exports.build = function(title, pagetitle, content){
    ...
    '<head>',
      ...
      '<script type="text/javascript" src="assets/javascript/home-grid.js"></script>',
			'<script type="text/javascript" src="assets/javascript/open-image.js"></script>',
      ...
      '<nav class="navbar navbar-inverse">',
        	...
        	'<div class="collapse navbar-collapse" id="myNavbar">',
          	'<ul class="nav navbar-nav navbar-right">',
            	'<li><a href="about"><span class="=about"></span>About</a></li>',
    					'<li class="dropdown">',
    	          '<a class="dropdown-toggle profile" data-toggle="dropdown" href="#"><img id="profilePic" src="assets/images/pip.PNG" width="50px" height="50px"><span class="caret"></span></a>',
        ...
        '<div class="explore-content">',
      	  '<div class="grid">',
      	    ...
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/dinah.JPG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/rowing.JPG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/rowing2.jpg"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/dog.JPG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/cape.JPG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/pip.PNG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/snow.JPG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/compound.PNG"></a>',
      	    '</div>',
      	    '<div class="grid-item">',
      	      '<a href="#" class="pop"><img src="assets/images/food.JPG"></a>',
      	    '</div>',
      	  '</div>',
        '</div>',
